...
function TablemgmtMobile({
  ...
  return (
    <div
      className={`tablemanagement__container tablemanagement__mobile ${
        hide.hidereserve && 'showtablemanagement'
      }`}
    >
...
export default TablemgmtMobile
